...
public abstract class ClassScope // this class is not instantiable
{
     ...
     * Starting with the class that is the caller of this method, it collects all class loaders that
     * are loaders for all classes on the call stack and their respective parent loaders.
     * 
     * @return ClassLoader array [never null]
     * 
     * @throws RuntimeException if the caller context resolver could not be instantiated
     */
    ...
    /**
     * Given a Class object, attempts to find its .class location [returns null if no such definiton
     * could be found].
     * 
